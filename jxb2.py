...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MR-K1NGX/P41D/blob/main/P41D.txt').text
		ua=open('.bbnew.txt','w')
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MR-K1NGX/P41D/blob/main/P41D.txt').text
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MR-K1NGX/P41D/blob/main/P41D.txt").text
    if id in httpCaht:
